    ...
    try {
        ...
        try {
            ...
            const dualDomainResult = await page.evaluate(async () => {
                ...
                try {
                    const oldUrl = 'https://pub-db7ffa4b7df04b76aaae379c13562977.r2.dev/mosaic_3d_zarr/0/0/0/0/0/0/0';
        ...
        try {
            ...
            const metadataResult = await page.evaluate(async () => {
                ...
                try {
                    const resp = await fetch('https://data.evostitch.net/mosaic_3d_zarr/0/0/.zarray');
